		...
		return el( 'svg', { class: 'sgdg-block-icon', viewBox: '0 0 103 89' }, [
			el( 'defs', null, [
				el(
					'style',
					null,
					'.cls-2 {opacity: 0.5;} .cls-3 {fill: #ffcf4a;} .cls-4 {fill: #25a366;} .cls-5 {fill: #4385f4;} .cls-6 {fill: #0da960;} .cls-7 {fill: url(#a);} .cls-8 {fill: url(#b);} .cls-9 {fill: #2d6fdd;} .cls-10 {fill: #e5b93c;} .cls-11 {fill: #0c9b57;}'
				),
				el(
					'radialGradient',
					{
						...
						r: '21.21',
						gradientTransform:
							'matrix(2.83 1.63 1.63 -2.83 -14102 6364.8)',
			...
			el( 'g', { transform: 'translate(-13.66,-20.66)' }, [
				...
				el( 'path', {
					class: 'cls-3',
					d:
						'm106.45 51.72a5.16 5.16 0 0 1 5.14 5.14v42.14a5.16 5.16 0 0 1 -5.14 5.14h-57a5.16 5.16 0 0 1 -5.14 -5.14v-42.14a5.16 5.16 0 0 1 5.14 -5.14h57m0-3.22h-57a8.37 8.37 0 0 0 -8.36 8.36v42.14a8.37 8.37 0 0 0 8.36 8.36h57a8.37 8.37 0 0 0 8.36 -8.36v-42.14a8.37 8.37 0 0 0 -8.36 -8.36z',
					fill: '#ffcf4a',
				} ),
				el( 'g', { fill: '#ffcf4a' }, [
					el( 'circle', {
				...
				el( 'path', {
					class: 'cls-4',
					d:
						'm93.59 38.87a5.15 5.15 0 0 1 5.14 5.13v42.18a5.16 5.16 0 0 1 -5.14 5.15h-57a5.16 5.16 0 0 1 -5.14 -5.15v-42.18a5.15 5.15 0 0 1 5.14 -5.14h57m0-3.23h-57a8.38 8.38 0 0 0 -8.35 8.37v42.18a8.37 8.37 0 0 0 8.36 8.37h57a8.38 8.38 0 0 0 8.4 -8.37v-42.18a8.39 8.39 0 0 0 -8.37 -8.37z',
					fill: '#25a366',
				} ),
				el( 'g', { fill: '#25a366' }, [
					el( 'circle', {
					...
					el( 'path', {
						class: 'cls-4',
						d:
							'm47.23 91.76c1.76-9.28 7.6-16.15 14.48-16.15h6.77c6.88 0 12.72 6.87 14.48 16.15z',
					} ),
					el( 'circle', {
						class: 'cls-4',
						cx: '87.85',
					...
					el( 'path', {
						class: 'cls-4',
						d:
							'm77.07 75.61c1.06-5.6 4.58-9.74 8.73-9.74h4.09c4.15 0 7.68 4.14 8.74 9.74z',
					} ),
					el( 'circle', {
						class: 'cls-4',
						cx: '42.34',
				...
				el( 'path', {
					class: 'cls-5',
					d:
						'm80.74 26a5.16 5.16 0 0 1 5.14 5.14v42.19a5.16 5.16 0 0 1 -5.14 5.14h-57a5.16 5.16 0 0 1 -5.14 -5.14v-42.18a5.16 5.16 0 0 1 5.14 -5.15h57m0-3.22h-57a8.37 8.37 0 0 0 -8.36 8.36v42.19a8.37 8.37 0 0 0 8.36 8.36h57a8.37 8.37 0 0 0 8.36 -8.36v-42.18a8.37 8.37 0 0 0 -8.36 -8.36z',
					fill: '#4385f4',
				} ),
			] ),
			el( 'g', { transform: 'translate(-13.66,-20.66)' }, [
				el( 'path', {
					class: 'cls-6',
					d: 'm40.66 67.63-6.18-10.71 11.58-20.07 6.18 10.71z',
					fill: '#0da960',
				} ),
				el( 'path', {
					class: 'cls-7',
					d: 'm40.66 67.63 6.19-10.71h23.15l-6.18 10.71z',
					fill: 'url(#a)',
				} ),
				el( 'path', {
					class: 'cls-8',
					d: 'm70 56.92h-12.37l-11.57-20.07h12.37z',
					fill: 'url(#b)',
				} ),
				el( 'path', {
					class: 'cls-9',
					d: 'm52.24 56.92h-5.39l2.68-4.68-8.87 15.39z',
					fill: '#2d6fdd',
				} ),
				el( 'path', {
					class: 'cls-10',
					d: 'm57.63 56.92h12.37l-15-4.68z',
					fill: '#e5b93c',
				} ),
				el( 'path', {
					class: 'cls-11',
					d: 'm49.53 52.24 2.71-4.68-6.18-10.71z',
					fill: '#0c9b57',
				} ),
			] ),
		] );
