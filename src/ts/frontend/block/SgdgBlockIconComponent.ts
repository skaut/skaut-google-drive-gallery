...
export class SgdgBlockIconComponent extends Component {
	public override render(): React.ReactNode {
		return createElement('svg', { viewBox: '0 0 128 128' }, [
			...
			createElement('path', {
				d: 'M63.44,60.25a3.05,3.05,0,0,1,3,3V88.21a3.05,3.05,0,0,1-3,3H29.76a3.05,3.05,0,0,1-3-3V63.29a3.05,3.05,0,0,1,3-3H63.44m0-1.9H29.76a4.94,4.94,0,0,0-4.94,4.94V88.21a5,5,0,0,0,4.94,5H63.44a5,5,0,0,0,4.94-5V63.29a4.94,4.94,0,0,0-4.94-4.94Z',
				fill: '#25a366',
			}),
			createElement('polygon', {
				points: '52.39 65.19 42.78 80.5 38.22 73.47 27.13 89.98 28.71 91.25 64.4 91.25 66.07 90.05 52.39 65.19',
				fill: '#25a366',
			}),
			createElement('image', {
				width: '46',
			...
			createElement('path', {
				d: 'M96.64,49.57a3,3,0,0,1,3,3V77.53a3,3,0,0,1-3,3H63a3.05,3.05,0,0,1-3-3V52.61a3,3,0,0,1,3-3H96.64m0-1.91H63a5,5,0,0,0-5,5V77.53a5,5,0,0,0,5,4.94H96.64a4.94,4.94,0,0,0,4.94-4.94V52.61a5,5,0,0,0-4.94-5Z',
				fill: '#ffcf4a',
			}),
			...
			createElement('path', {
				d: 'M69.24,80.82c1-5.48,4.49-9.54,8.55-9.54h4c4.06,0,7.51,4.06,8.55,9.54Z',
				fill: '#ffcf4a',
			}),
			createElement('circle', {
				cx: '93.24',
			...
			createElement('path', {
				d: 'M86.87,71.28C87.5,68,89.58,65.53,92,65.53h2.42c2.45,0,4.54,2.44,5.16,5.75Z',
				fill: '#ffcf4a',
			}),
			createElement('circle', {
				cx: '66.35',
			...
			createElement('path', {
				d: 'M60,71.28c.63-3.31,2.71-5.75,5.16-5.75h2.42c2.45,0,4.53,2.44,5.16,5.75Z',
				fill: '#ffcf4a',
			}),
		]);
	}
