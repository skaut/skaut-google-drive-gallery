...
final class Options {
	...
	public static function init() {
		...
		self::$authorized_domain = new \Sgdg\Admin\Readonly_String_Option(
			'authorized_domain',
			$url['host'],
			'basic',
			'auth',
		...
		self::$authorized_origin = new \Sgdg\Admin\Readonly_String_Option(
			'origin',
			$url['scheme'] . '://' . $url['host'],
			'basic',
			'auth',
		...
		self::$redirect_uri      = new \Sgdg\Admin\Readonly_String_Option(
			'redirect_uri',
		...
		self::$client_id         = new \Sgdg\Frontend\Code_String_Option(
			'client_id',
			'',
			'basic',
			'auth',
		...
		self::$client_secret     = new \Sgdg\Frontend\Code_String_Option(
			'client_secret',
			'',
			'basic',
			'auth',
		...
		self::$root_path = new \Sgdg\Frontend\Root_Path_Option(
			'root_path',
			array( 'root' ),
			'basic',
			'root_selection',
		...
		self::$grid_height    = new \Sgdg\Frontend\Bounded_Integer_Option(
			'grid_height',
			250,
			1,
			'advanced',
		...
		self::$grid_spacing   = new \Sgdg\Frontend\Integer_Option(
			'grid_spacing',
			10,
			'advanced',
			'grid',
		...
		self::$dir_title_size = new \Sgdg\Frontend\String_Option(
			'dir_title_size',
			'1.2em',
			'advanced',
			'grid',
		...
		self::$dir_counts     = new \Sgdg\Frontend\Boolean_Option(
			'dir_counts',
			true,
			'advanced',
			'grid',
		...
		self::$page_size      = new \Sgdg\Frontend\Bounded_Integer_Option(
			'page_size',
			50,
			1,
			'advanced',
		...
		self::$page_autoload  = new \Sgdg\Frontend\Boolean_Option(
			'page_autoload',
			true,
			'advanced',
			'grid',
		...
		self::$image_ordering = new \Sgdg\Frontend\Ordering_Option(
			'image_ordering',
			'time',
			'ascending',
			'advanced',
		...
		self::$dir_ordering   = new \Sgdg\Frontend\Ordering_Option(
			'dir_ordering',
			'time',
			'descending',
			'advanced',
		...
		self::$dir_prefix     = new \Sgdg\Frontend\String_Option(
			'dir_prefix',
			'',
			'advanced',
			'grid',
		...
		self::$preview_size               = new \Sgdg\Frontend\Bounded_Integer_Option(
			'preview_size',
			1920,
			1,
			'advanced',
		...
		self::$preview_speed              = new \Sgdg\Frontend\Bounded_Integer_Option(
			'preview_speed',
			250,
			0,
			'advanced',
		...
		self::$preview_arrows             = new \Sgdg\Frontend\Boolean_Option(
			'preview_arrows',
			true,
			'advanced',
			'lightbox',
		...
		self::$preview_close_button       = new \Sgdg\Frontend\Boolean_Option(
			'preview_closebutton',
			true,
			'advanced',
			'lightbox',
		...
		self::$preview_loop               = new \Sgdg\Frontend\Boolean_Option(
			'preview_loop',
			false,
			'advanced',
			'lightbox',
		...
		self::$preview_activity_indicator = new \Sgdg\Frontend\Boolean_Option(
			'preview_activity',
			true,
			'advanced',
			'lightbox',
		...
		self::$preview_captions           = new \Sgdg\Frontend\Boolean_Option(
			'preview_captions',
			true,
			'advanced',
			'lightbox',
