...
class Options {
	...
	public static function init() {
		...
		self::$image_ordering = new \Sgdg\Frontend\Ordering_Option( 'image_ordering', 'date', 'ascending', 'advanced', 'grid', esc_html__( 'Image and video ordering', 'skaut-google-drive-gallery' ) );
		self::$dir_ordering   = new \Sgdg\Frontend\Ordering_Option( 'dir_ordering', 'date', 'descending', 'advanced', 'grid', esc_html__( 'Directory ordering', 'skaut-google-drive-gallery' ) );
