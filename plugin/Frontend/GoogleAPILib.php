...
function getRawClient() : \Sgdg\Vendor\Google_Client
{
	...
	$client->setAuthConfig(['client_id' => \Sgdg_plugin::$clientID->get(), 'client_secret' => get_option('sgdg_client_secret'), 'redirect_uris' => [esc_url_raw(admin_url('options-general.php?page=sgdg&action=oauth_redirect'))]]);
