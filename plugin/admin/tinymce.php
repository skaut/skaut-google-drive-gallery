...
function add() {
	...
	echo( '<a href="#" id="sgdg-tinymce-button" class="button"><img class="sgdg-tinymce-button-icon" src="' . plugins_url( '/skaut-google-drive-gallery/admin/icon64.png' ) . '">' . esc_html__( 'Google Drive gallery', 'skaut-google-drive-gallery' ) . '</a>' ); // TODO: Icon
	add_thickbox();
}
